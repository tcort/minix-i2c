...
static void
dm37xx_configure_display(int minor)
{
...
int
dm37xx_get_device(int minor, struct device *dev)
{
...
int
dm37xx_get_varscreeninfo(int minor, struct fb_var_screeninfo *fbvsp)
{
	if (!initialized) return ENXIO;
	if (minor != 0) return ENXIO;
...
int
dm37xx_put_varscreeninfo(int minor, struct fb_var_screeninfo *fbvsp)
{
	int r = OK;
	...
	dm37xx_configure_display(minor);
	return OK;
}

int
dm37xx_get_fixscreeninfo(int minor, struct fb_fix_screeninfo *fbfsp)
{
	if (!initialized) return ENXIO;
	if (minor != 0) return ENXIO;
...
int
dm37xx_pan_display(int minor, struct fb_var_screeninfo *fbvsp)
{
	return dm37xx_put_varscreeninfo(minor, fbvsp);
}

int
dm37xx_fb_init(int minor, struct device *dev, struct edid_info *info)
{
	int r;
	u32_t rdispc;
